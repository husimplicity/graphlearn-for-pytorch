...
class GrinDataset:
  ...
  def get_node_feature(self, n_ids, ntype: Optional[str]=None):
    if ntype is None:
      return self.node_features[n_ids]
    return self.node_features[ntype][n_ids]

  def get_edge_feature(self, e_ids, etype: Optional[EdgeType]=None):
    if etype is None:
      return self.edge_features[e_ids]
    return self.edge_features[etype][e_ids]

  def get_node_label(self, n_ids, ntype: Optional[str]=None):
    if ntype is None:
      return self.node_features[ntype].get_labels(n_ids)
