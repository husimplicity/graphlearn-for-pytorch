...
//         auto src_degree = grin_get_adjacent_list_size(graph, src_adj_list);
...
//             auto out_v = grin_get_neighbor_from_adjacent_list(
//               graph, src_adj_list, dist(engine));
